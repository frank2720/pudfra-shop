                ...
                <div class="product-inner pr">
                    <div class="product-image pr oh">
                        ...
                        <a class="d-block" href="{{route('product.details',['id'=>$product->id])}}">
                            <img data-src="{{Storage::url($product->img_urls['urls'][0])}}" class="pr_lazy_img main-img nt_bg_lz lazyload" alt="...">
                        </a>
                        <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                            <img data-src="{{Storage::url($product->img_urls['urls'][1]??$product->img_urls['urls'][0])}}" class="pr_lazy_img back-img pa nt_bg_lz lazyload" alt="..">
                        </div>
