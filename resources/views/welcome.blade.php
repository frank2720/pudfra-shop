    ...
    <!-- ./features -->
            ...
            <div class="container pb-16">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div class="bg-white shadow rounded overflow-hidden group">
                        ...
                        <div class="pt-4 pb-3 px-4">
                            ...
                            <div class="flex items-baseline mb-1 space-x-2">
                                <p class="text-xl text-blue-600 font-semibold">Ksh. {{number_format(1000)}}</p>
                                <p class="text-sm text-gray-400 line-through">Ksh. {{number_format(1500)}}</p>
                            </div>
                    ...
                    <div class="bg-white shadow rounded overflow-hidden group">
                        <div class="relative">
                            <img src="assets/images/products/product8.jpg" alt="product 1" class="w-full">
                            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                                <a href="#"
                                    class="text-white text-lg w-9 h-8 rounded-full bg-blue-600 flex items-center justify-center hover:bg-gray-800 transition"
                                    title="view product">
                        ...
                        <div class="pt-4 pb-3 px-4">
                            ...
                            <div class="flex items-baseline mb-1 space-x-2">
                                <p class="text-xl text-blue-600 font-semibold">Ksh. {{number_format(1000)}}</p>
                                <p class="text-sm text-gray-400 line-through">Ksh. 1500</p>
                            </div>
                            <div class="flex items-center">
                                <div class="flex gap-1 text-sm text-yellow-400">
                                    <span><i class="fa-solid fa-star"></i></span>
