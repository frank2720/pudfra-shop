        ...
        <!-- Input Number -->
          <div class="py-2 px-3 inline-block bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700" data-hs-input-number>
              <div class="flex items-center gap-x-1.5">
                  <a href="{{route('productReduce',['id'=>$product['item']->id])}}">
                  ...
                  <label>
                      <input class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white" type="number" placeholder="0" value="{{$product['qty']}}" data-hs-input-number-input disabled>
                  </label>
