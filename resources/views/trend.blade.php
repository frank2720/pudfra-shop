            ...
            <div class="product-image position-relative oh lazyload">
               <!-- @if ($product->retail_price>$product->price)
                ...
                <a class="d-block" href="{{route('product.details',['id'=>$product->id])}}">
                    <img src="{{Storage::url($product->images[0]->url??null)}}" class="main-img nt_bg_lz img-same-height" alt="..">
                </a>
                <div class="hover_img pa pe_none t__0 l__0 r__0 b__0 op__0">
                    <img src="{{Storage::url($product->images[1]->url??$product->images[0]->url??null)}}" class="back-img pa nt_bg_lz lazyload img-same-height" alt="..">
                </div>
